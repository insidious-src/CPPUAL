...
public:
    ...
    inline virtual ~memory_resource () = default;
...
template <class_t T>
inline constexpr bool const is_memory_resource_v = is_memory_resource<T>::value;
...
/// is allocator -> value
template <class_t A>
inline constexpr bool const is_allocator_v = is_allocator<A>::value;

...
#ifndef CPPUAL_AUDIO_LISTENER_H_
#define CPPUAL_AUDIO_LISTENER_H_
#ifdef __cplusplus
...
void    SHARED_API set_position (point3f const& position) noexcept;
...
#endif // __cplusplus
#endif // CPPUAL_AUDIO_LISTENER_H_

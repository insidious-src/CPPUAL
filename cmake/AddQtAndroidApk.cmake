...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    add_custom_target(
        ...
        COMMAND ${QT_ANDROID_QT_ROOT}/bin/androiddeployqt --verbose --output ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}-apk --input ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}-source/qtdeploy.json --gradle ${TARGET_LEVEL_OPTIONS} ${INSTALL_OPTIONS} ${SIGN_OPTIONS}
    )
